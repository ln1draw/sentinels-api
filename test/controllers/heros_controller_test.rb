...
class HerosControllerTest < ActionController::TestCase
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post :create, hero: { active: @hero.active, effects: @hero.effects, hp: @hero.hp, name: @hero.name }
    end
  ...
  test "should update hero" do
    patch :update, id: @hero, hero: { active: @hero.active, effects: @hero.effects, hp: @hero.hp, name: @hero.name }
    assert_redirected_to hero_path(assigns(:hero))
  end
